$(document).ready(function () {
	...
	/* easy pie chart events end*/

	// toaster plugin
	$('.open-toaster').click(function () {
		var toaster = $(this).next(".toaster1").fadeIn('slow');
		hidetoaster(toaster);
	});
	$(".toaster1close").click(function () {
		$(".toaster1").fadeOut('slow');
	...
	// slimScroll trigger
		...
		$('.card-menu-btn').on('click', function (g) {
			...
			$menu_box3.siblings().find('.card-menu-details').hide();
